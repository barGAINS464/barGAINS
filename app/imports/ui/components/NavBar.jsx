            ...
            <Menu.Item>
              <Dropdown text='Shop'>
                <Dropdown.Menu>
                  ...
                  <Dropdown.Item text='Books' as={NavLink} exact to="/shop" />
                  <Dropdown.Item text='Computers' as={NavLink} exact to="/shop" />
                  <Dropdown.Item text='Music' as={NavLink} exact to="/shop" />
                </Dropdown.Menu>
              </Dropdown>
            </Menu.Item>]
        ) : ''}
