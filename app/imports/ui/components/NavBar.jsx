      ...
      <Menu style={menuStyle} attached="top" borderless inverted>
        ...
        {this.props.currentUser ? (
          [<Menu.Item as={NavLink} activeClassName="active" exact to="/add" key='add'>Post Item</Menu.Item>,
            ...
            <Menu.Item as={NavLink} activeClassName="active" exact to="/userReview" key='userReview'>Reviews</Menu.Item>]
        ) : ''}
        {Roles.userIsInRole(Meteor.userId(), 'admin') ? (
          [<Menu.Item key='drop-down admin'>
            <Dropdown text='Admin'>
              <Dropdown.Menu>
                <Dropdown.Item text='Products' as={NavLink} activeClassName="active" exact to="/admin" key='admin'/>
                <Dropdown.Item text='Profiles' as={NavLink} activeClassName="active" exact to="/profileadmin" key='profileadmin'/>
              </Dropdown.Menu>
            </Dropdown>
          </Menu.Item>]
        ) : ''}
